(() => {
    ...
    const Utility = {
        ...
        googleMapApiKey: () => "AIzaSyDHBvGs5No6nr62Ba-pl_diMTUodFrXRFo",
        fetch: (url) => {
    ...
    const App = {
        ...
        getManualLocationData() {
            ...
            const text = localStorage.getItem('manual-location') || ''
        ...
        async registerEventForForceLoadLocationAndPrayerTimes() {
            ...
            $('.detect-data-automatically').on('click', async () => {
                ...
                Swal.fire({
                    ...
                    localStorage.removeItem('manual-location')
                    this.loadLocationAndPrayerTimeThenRender.call(this)
                })
            })
            ...
            if (chrome.alarms) {
                ...
                chrome.alarms.onAlarm.addListener((alarm) => {
                    ...
                    chrome.notifications.create(info[0], {
                        type: 'basic',
                        iconUrl: 'assets/images/clock.png',
                        title: info[1],
                        message: info[2]
                    }, $.noop)
                })
