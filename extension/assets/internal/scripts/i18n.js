const I18n = {
    mapping: {
        ...
        languageName: {
            ar: { english: 'Arabic', native: 'اللغة العربية' },
            en: { english: 'English' },
            ru: { english: 'Russian', native: 'Русский язык' },
            bn: { english: 'Bengali', native: 'বাংলা' },
            hi: { english: 'Hindi', native: 'हिन्दी' },
            id: { english: 'Bahasa Indonesia' },
            'zh-tw': { english: 'Chinese (Traditional)', native: '中文 (繁體)' },
            'zh-cn': { english: 'Chinese (Simplified)', native: '中文 (简体)' },
        },

        daySunday:    { ar: 'الأحد', en: 'Sunday', ru: 'Воскресенье', bn: 'রবিবার', hi: 'रविवार', id: 'Ahad', 'zh-tw': '星期日', 'zh-cn': '星期日' },
        dayMonday:    { ar: 'الأثنين', en: 'Monday', ru: 'Понедельник', bn: 'সোমবার', hi: 'सोमवार', id: 'Senin', 'zh-tw': '星期一', 'zh-cn': '星期一' },
        dayTuesday:   { ar: 'الثلاثاء', en: 'Tuesday', ru: 'Вторник', bn: 'মঙ্গলবার', hi: 'मंगलवार', id: 'Selasa', 'zh-tw': '星期二', 'zh-cn': '星期二' },
        dayWednesday: { ar: 'الأربعاء', en: 'Wednesday', ru: 'Среда', bn: 'বুধবার', hi: 'बुधवार', id: 'Rabu', 'zh-tw': '星期三', 'zh-cn': '星期三' },
        dayThursday:  { ar: 'الخميس', en: 'Thursday', ru: 'Четверг', bn: 'বৃহস্পতিবার', hi: 'गुरुवार', id: 'Kamis', 'zh-tw': '星期四', 'zh-cn': '星期四' },
        dayFriday:    { ar: 'الجمعة', en: 'Friday', ru: 'Пятница', bn: 'শুক্রবার', hi: 'शुक्रवार', id: 'Jumat', 'zh-tw': '星期五', 'zh-cn': '星期五' },
        daySaturday:  { ar: 'السبت', en: 'Saturday', ru: 'Суббота', bn: 'শনিবার', hi: 'शनिवार', id: 'Sabtu', 'zh-tw': '星期六', 'zh-cn': '星期六' },

        monthJanuary:   { ar:'يناير', en: 'January', ru: 'Январь', bn: 'জানুয়ারী', hi: 'जनवरी', id: 'Januari', 'zh-tw': '一月', 'zh-cn': '一月' },
        monthFebruary:  { ar:'فبراير', en: 'February', ru: 'Февраль', bn: 'ফেব্রুয়ারী', hi: 'फ़रवरी', id: 'Februari', 'zh-tw': '二月', 'zh-cn': '二月' },
        monthMarch:     { ar:'مارس', en: 'March', ru: 'Март', bn: 'মার্চ', hi: 'मार्च', id: 'Maret', 'zh-tw': '三月', 'zh-cn': '三月' },
        monthApril:     { ar:'أبريل', en: 'April', ru: 'Апрель', bn: 'এপ্রিল', hi: 'अप्रैल', id: 'April', 'zh-tw': '四月', 'zh-cn': '四月' },
        monthMay:       { ar:'مايو', en: 'May', ru: 'Май', bn: 'মে', hi: 'मई', id: 'Mei', 'zh-tw': '五月', 'zh-cn': '五月' },
        monthJune:      { ar:'يونيو', en: 'June', ru: 'Июнь', bn: 'জুন', hi: 'जून', id: 'Juni', 'zh-tw': '六月', 'zh-cn': '六月' },
        monthJuly:      { ar:'يوليو', en: 'July', ru: 'Июль', bn: 'জুলাই', hi: 'जुलाई', id: 'July', 'zh-tw': '七月', 'zh-cn': '七月' },
        monthAugust:    { ar:'أغسطس', en: 'August', ru: 'Август', bn: 'আগস্ট', hi: 'अगस्त', id: 'Agustus', 'zh-tw': '八月', 'zh-cn': '八月' },
        monthSeptember: { ar:'سبتمبر', en: 'September', ru: 'Сентябрь', bn: 'সেপ্টেম্বর', hi: 'सितंबर', id: 'September', 'zh-tw': '九月', 'zh-cn': '九月' },
        monthOctober:   { ar:'أكتوبر', en: 'October', ru: 'Октябрь', bn: 'অক্টোবর', hi: 'अक्टूबर', id: 'Oktober', 'zh-tw': '十月', 'zh-cn': '十月' },
        monthNovember:  { ar:'نوفمبر', en: 'November', ru: 'Ноябрь', bn: 'নভেম্বর', hi: 'नवंबर', id: 'November', 'zh-tw': '十一月', 'zh-cn': '十一月' },
        monthDecember:  { ar:'ديسمبر', en: 'December', ru: 'Декабрь', bn: 'ডিসেম্বর', hi: 'दिसंबर', id: 'Desember', 'zh-tw': '十二月', 'zh-cn': '十二月' },

        monthHijr1:  { ar: 'محرم', en: 'Muḥarram', ru: 'Мухаррам', bn: 'মুহররম', hi: 'मुहर्रम', id: 'Muharram', 'zh-tw': '穆哈兰姆月', 'zh-cn': '穆哈兰姆月' },
        monthHijr2:  { ar: 'صفر', en: 'Ṣafar', ru: 'Сафар', bn: 'সফর', hi: 'सफ़र', id: 'Shafar', 'zh-tw': '色法尔月', 'zh-cn': '色法尔月' },
        monthHijr3:  { ar: 'ربيع الأول', en: 'Rabīʿ al-Awwal', ru: 'Раби аль-авваль', bn: 'রবিউল আউয়াল', hi: 'रबीउल अव्वल', id: 'Rabiul Awwal', 'zh-tw': '赖比尔·敖外鲁月', 'zh-cn': '赖比尔·敖外鲁月' },
        monthHijr4:  { ar: 'ربيع الآخر', en: 'Rabīʿ al-Thānī', ru: 'Раби ас-сани', bn: 'রবিউছ ছানি', hi: 'रबीउल आखिर', id: 'Rabiul Akhir', 'zh-tw': '赖比尔·阿色尼月', 'zh-cn': '赖比尔·阿色尼月' },
        monthHijr5:  { ar: 'جمادى الأول', en: 'Jumādā al-Awwal', ru: 'Джумада аль-уля', bn: 'জামাদিউল আউয়াল', hi: 'जमादी-उल-अव्वल', id: 'Jumadil Awwal', 'zh-tw': '主马达·敖外鲁月', 'zh-cn': '主马达·敖外鲁月' },
        monthHijr6:  { ar: 'جمادى الآخر', en: 'Jumādā al-Thānī', ru: 'Джумада ас-сани', bn: 'জামাদিউছ ছানি', hi: 'जुमादा अल-आखिर', id: 'Jumadil Akhir', 'zh-tw': '主马达·阿色尼月', 'zh-cn': '主马达·阿色尼月' },
        monthHijr7:  { ar: 'رجب', en: 'Rajab', ru: 'Раджаб', bn: 'রজব', hi: 'रजब', id: 'Rajab', 'zh-tw': '赖哲卜月', 'zh-cn': '赖哲卜月' },
        monthHijr8:  { ar: 'شعبان', en: 'Shaʿbān', ru: 'Шабан', bn: 'শা’বান', hi: 'शाबान', id: 'Sya`ban', 'zh-tw': '舍爾邦月', 'zh-cn': '舍尔邦月' },
        monthHijr9:  { ar: 'رمضان', en: 'Ramaḍān', ru: 'Рамадан', bn: 'রামজান', hi: 'रमजान', id: 'Ramadhan', 'zh-tw': '賴買丹月', 'zh-cn': '赖买丹月' },
        monthHijr10: { ar: 'شوال', en: 'Shawwāl', ru: 'Шавваль', bn: 'শাওয়াল', hi: 'शव्वाल', id: 'Syawwal', 'zh-tw': '閃瓦魯月', 'zh-cn': '闪瓦鲁月' },
        monthHijr11: { ar: 'ذو القعدة', en: 'Dhū al-Qaʿdah', ru: 'Зу-ль-када', bn: 'জিলক্বদ', hi: 'ज़िल क़ादा', id: 'Dzulqo`dah', 'zh-tw': '都尔喀尔德月', 'zh-cn': '都尔喀尔德月' },
        ...
        prayerTimeSunrise: { ar:'الشروق', en: 'Sunrise', ru: 'Рассвет', bn: 'সূর্যোদয়', hi: 'सूर्योदय', id: 'Dhuha', 'zh-tw': '日出', 'zh-cn': '日出' },
        prayerTimeDhuhr:   { ar:'الظهر', en: 'Dhuhr', ru: 'Зухр', bn: 'যোহর', hi: 'ज़ोहर', id: 'Dzuhur', 'zh-tw': '晌禮', 'zh-cn': '中午' },
        prayerTimeAsr:     { ar:'العصر', en: 'Asr', ru: 'Аср', bn: 'আসর', hi: 'अस्र', id: 'Ashar', 'zh-tw': '晡禮', 'zh-cn': '下午' },
        prayerTimeMaghrib: { ar:'المغرب', en: 'Maghrib', ru: 'Магриб', bn: 'মাগরিব', hi: 'मग़रिब', id: 'Maghrib', 'zh-tw': '昏禮', 'zh-cn': '黄昏' },
        prayerTimeIsha:    { ar:'العشاء', en: 'Isha', bn: 'ইশা', hi: 'ईशा', id: `Isya'`, ru: 'Иша', 'zh-tw': '宵禮', 'zh-cn': '晚上' },
        ...
        prayerCalculationSummaryDefault: {
            ar: 'الطريقة الافتراضية ($1 · $2)',
            en: 'Default method ($1 · $2)',
            ru: 'Метод по умолчанию ($1 · $2)',
            bn: 'ডিফল্ট পদ্ধতি ($1 · $2)',
            hi: 'डिफ़ॉल्ट विधि ($1 · $2)',
            id: 'Metode default ($1 · $2)',
            'zh-tw': '預設方法（$1 · $2）',
            'zh-cn': '默认方法（$1 · $2）'
        },
        ...
        modalAboutUsText1: {
            ...
            bn: '$1 হল মুসলমানদের জন্য একটি ব্যক্তিগত ড্যাশবোর্ড, যা সমস্ত আধুনিক ব্রাউজারে আছে। এই ব্রাউজার এক্সটেনশনটি Momentum দ্বারা অনুপ্রাণিত।', 
            hi: '$1 मुसलमानों के लिए एक व्यक्तिगत डैशबोर्ड है, जो सभी आधुनिक ब्राउज़रों में उपलब्ध है. यह ब्राउज़र एक्सटेंशन Momentum से प्रेरित है.',
