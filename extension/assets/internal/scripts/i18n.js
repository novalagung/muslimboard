const I18n = {
    mapping: {
        ...
        monthMuharram: 		{ ar: 'محرم',       en: 'Muḥarram',         id: 'Muharram',        'zh-tw': '穆哈兰姆月' },
        monthShafar: 		{ ar: 'صفر',        en: 'Ṣafar',            id: 'Shafar',          'zh-tw': '色法尔月' },
        monthRabiulAwwal:	{ ar: 'ربيع الأول',  en: 'Rabīʿ al-Awwal',   id: 'Rabiul Awwal',    'zh-tw': '赖比尔·敖外鲁月' },
        monthRabiulAkhir:	{ ar: 'ربيع الآخر',  en: 'Rabīʿ al-Thānī',   id: 'Rabiul Akhir',    'zh-tw': '赖比尔·阿色尼月' },
        monthJumadilAwwal:	{ ar: 'جمادى الأول', en: 'Jumādā al-Awwal',  id: 'Jumadil Awwal',   'zh-tw': '主马达·敖外鲁月' },
        monthJumadilAkhir:	{ ar: 'جمادى الآخر', en: 'Jumādā al-Thānī',  id: 'Jumadil Akhir',   'zh-tw': '主马达·阿色尼月' },
        monthRajab:			{ ar: 'رجب',        en: 'Rajab',            id: 'Rajab',           'zh-tw': '赖哲卜月' },
        monthSyaban:		{ ar: 'شعبان',      en: 'Shaʿbān',          id: 'Sya`ban',         'zh-tw': '舍爾邦月' },
        monthRamadhan:		{ ar: 'رمضان',      en: 'Ramaḍān',          id: 'Ramadhan',        'zh-tw': '賴買丹月' },
        monthSyawwal:		{ ar: 'شوال',       en: 'Shawwāl',          id: 'Syawwal',         'zh-tw': '閃瓦魯月' },
        monthDzulqodah:		{ ar: 'ذو القعدة',  en: 'Dhū al-Qaʿdah',    id: 'Dzulqo`dah',      'zh-tw': '都尔喀尔德月' },
        monthDzulhijjah:	{ ar: 'ذو الحجة',   en: 'Dhū al-Ḥijjah',    id: 'Dzulhijjah',      'zh-tw': '都爾黑哲月' },

        month1: 	{ ar: 'محرم',       en: 'Muḥarram',         id: 'Muharram',        'zh-tw': '穆哈兰姆月' },
        month2: 	{ ar: 'صفر',        en: 'Ṣafar',            id: 'Shafar',          'zh-tw': '色法尔月' },
        month3:	    { ar: 'ربيع الأول',  en: 'Rabīʿ al-Awwal',   id: 'Rabiul Awwal',    'zh-tw': '赖比尔·敖外鲁月' },
        month4:	    { ar: 'ربيع الآخر',  en: 'Rabīʿ al-Thānī',   id: 'Rabiul Akhir',    'zh-tw': '赖比尔·阿色尼月' },
        month5:	    { ar: 'جمادى الأول', en: 'Jumādā al-Awwal',  id: 'Jumadil Awwal',   'zh-tw': '主马达·敖外鲁月' },
        month6:	    { ar: 'جمادى الآخر', en: 'Jumādā al-Thānī',  id: 'Jumadil Akhir',   'zh-tw': '主马达·阿色尼月' },
        month7:		{ ar: 'رجب',        en: 'Rajab',            id: 'Rajab',           'zh-tw': '赖哲卜月' },
        month8:		{ ar: 'شعبان',      en: 'Shaʿbān',          id: 'Sya`ban',         'zh-tw': '舍爾邦月' },
        month9:		{ ar: 'رمضان',      en: 'Ramaḍān',          id: 'Ramadhan',        'zh-tw': '賴買丹月' },
        month10:	{ ar: 'شوال',       en: 'Shawwāl',          id: 'Syawwal',         'zh-tw': '閃瓦魯月' },
        month11:	{ ar: 'ذو القعدة',  en: 'Dhū al-Qaʿdah',    id: 'Dzulqo`dah',      'zh-tw': '都尔喀尔德月' },
        month12:	{ ar: 'ذو الحجة',   en: 'Dhū al-Ḥijjah',    id: 'Dzulhijjah',      'zh-tw': '都爾黑哲月' },
