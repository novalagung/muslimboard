$(document).ready(function () {
    ...
    ">
        ...
        <span
            ...
            contenteditable="true" data-placeholder="Tulis sesuatu">New Todo</span>
    ...
    // if has localStorage, clear item and render from local storage, after that add done local storage
    ...
    $("#todo-main .items").on("input", ".item-textbox" , function () {
